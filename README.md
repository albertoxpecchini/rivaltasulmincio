...
| **Luoghi censiti** | **133** | 55 luoghi + 78 attività in `_build/luoghi.json`, 96 con coordinate OSM |
...
│   ├── luoghi.json             #   il registro dei 133 luoghi: coordinate, foto, schede
...
**[`_build/luoghi.json`](_build/luoghi.json)** è l'anagrafe dei posti di cui il sito parla: **133
voci**, 55 luoghi e 78 attività. Un file solo, perché le stesse informazioni servono a tre cose che
...
Le coordinate sono state prese dall'estratto OSM, non scritte a mano: **96 voci su 133** hanno un
...
Non serve toccare l'HTML: i segnaposto `{{foto:…}}` sono **già scritti** nelle pagine per tutte e 133
...
- **Senza JavaScript la pagina regge:** sotto la mappa c'è l'elenco completo dei 133 luoghi, ognuno
