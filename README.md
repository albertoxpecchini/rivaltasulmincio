...
| **Luoghi censiti** | **139** | 55 luoghi + 84 attività in `_build/luoghi.json`, 97 con coordinate OSM |
...
│   ├── luoghi.json             #   il registro dei 139 luoghi: coordinate, foto, schede
...
**[`_build/luoghi.json`](_build/luoghi.json)** è l'anagrafe dei posti di cui il sito parla: **139
voci**, 55 luoghi e 84 attività. Un file solo, perché le stesse informazioni servono a tre cose che
...
Le coordinate sono state prese dall'estratto OSM, non scritte a mano: **97 voci su 139** hanno un
...
Non serve toccare l'HTML: i segnaposto `{{foto:…}}` sono **già scritti** nelle pagine per tutte e 139
...
- **Senza JavaScript la pagina regge:** sotto la mappa c'è l'elenco completo dei 139 luoghi, ognuno
