...
│   ├── luoghi.json             #   il registro dei 127 luoghi: coordinate, foto, schede
...
**[`_build/luoghi.json`](_build/luoghi.json)** è l'anagrafe dei posti di cui il sito parla: **127
voci**, 55 luoghi e 72 attività. Un file solo, perché le stesse informazioni servono a tre cose che
...
Non serve toccare l'HTML: i segnaposto `{{foto:…}}` sono **già scritti** nelle pagine per tutte e 127
...
- **Senza JavaScript la pagina regge:** sotto la mappa c'è l'elenco completo dei 127 luoghi, ognuno
