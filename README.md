...
| **Luoghi censiti** | **154** | 66 luoghi + 88 attività in `_build/luoghi.json`, 112 con coordinate OSM |
...
│   ├── luoghi.json             #   il registro dei 154 luoghi: coordinate, foto, schede
...
**[`_build/luoghi.json`](_build/luoghi.json)** è l'anagrafe dei posti di cui il sito parla: **154
voci**, 66 luoghi e 88 attività. Un file solo, perché le stesse informazioni servono a tre cose che
...
Le coordinate sono state prese dall'estratto OSM, non scritte a mano: **112 voci su 154** hanno un
...
Non serve toccare l'HTML: i segnaposto `{{foto:…}}` sono **già scritti** nelle pagine per tutte e 154
...
- **Senza JavaScript la pagina regge:** sotto la mappa c'è l'elenco completo dei 154 luoghi, ognuno
